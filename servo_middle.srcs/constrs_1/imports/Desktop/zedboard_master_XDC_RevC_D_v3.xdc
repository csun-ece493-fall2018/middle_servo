...
set_property PACKAGE_PIN AA11 [get_ports {pwm_mid}];  # "JA2"
...
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN F22 [get_ports {sensor_angle[0]}];  # "SW0"
#set_property PACKAGE_PIN G22 [get_ports {sensor_angle[1]}];  # "SW1"
#set_property PACKAGE_PIN H22 [get_ports {sensor_angle[2]}];  # "SW2"
#set_property PACKAGE_PIN F21 [get_ports {sensor_angle[3]}];  # "SW3"
#set_property PACKAGE_PIN H19 [get_ports {sensor_angle[4]}];  # "SW4"
#set_property PACKAGE_PIN H18 [get_ports {sensor_angle[5]}];  # "SW5"
#set_property PACKAGE_PIN H17 [get_ports {sensor_angle[6]}];  # "SW6"
set_property PACKAGE_PIN M15 [get_ports {stop}];  # "SW7"
